...
# text = open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'the_iliad.txt'),encoding='utf-8').read().lower()
...
index = 15
single_word_tokenized_sentence = word_tokenized_text[index] # change sentence
...
single_pos_sentence = pos_tagged_text[index]
